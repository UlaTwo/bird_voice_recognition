...
class Audio():
    def __init__(self,path, file_name):
        ...
        #tutaj by sie jeszcze resample na wszelki wypadek przydało
...
class Classifier():
    def __init__(self,path, file_name):
        self.path = path
        self.file = file_name
        self.model = CNN_Audio_Model.load_from_checkpoint(checkpoint_path="./model.ckpt")
        self.trainer = pl.Trainer()
        self.left_column, self.right_column = st.beta_columns(2)
        #wczytanie wyniku z csv:
        self.csv_path = "./BirdVoxDCASE20k.csv"
